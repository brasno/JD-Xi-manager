...
class Digital_Synth(Digital_Synth_Base,Digital_Synth_Modify):
...
#      playbutton.update(text='Play Pressed')
            ...
            if attr in DigitalSynth1.attributes:
                DigitalSynth1.attributes[attr][0]=int(values[event])
                send_data=DigitalSynth1.attributes[attr][1]
            else:
                DigitalSynth1.dsm_attributes[attr][0]=int(values[event])
                send_data=DigitalSynth1.dsm_attributes[attr][1]
            send_sysex_DT1(DigitalSynth1,send_data,[int(values[event])])
            ...
            if attr in DigitalSynth2.attributes:
                DigitalSynth2.attributes[attr][0]=int(values[event])
                send_data=DigitalSynth2.attributes[attr][1]
            else:
                DigitalSynth2.dsm_attributes[attr][0]=int(values[event])
                send_data=DigitalSynth2.dsm_attributes[attr][1]
            send_sysex_DT1(DigitalSynth2,send_data,[int(values[event])])
